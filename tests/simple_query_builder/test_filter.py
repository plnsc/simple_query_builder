...
class TestFilter(unittest.TestCase):
    ...
    def test_dump_parts(self):
        ...
        self.assertEqual(self.filter.dump_parts(), " ".join(expected))
    ...
    def test_dump_globals(self):
        ...
        self.assertEqual(self.filter.dump_globals(), expected)
    ...
    def test_wrap_it_0(self):
        ...
        self.assertEqual(self.filter.dump_parts(), expected)
    ...
    def test_order_by_0(self):
        ...
        self.assertEqual(self.filter.dump_globals(), " ".join(expected))
    ...
    def test_between(self):
        ...
        self.assertEqual(filter.dump_parts(), expected)
